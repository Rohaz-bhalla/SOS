...
export const NavigationLayout: React.FC<Props> = ({ children }) => {
  ...
  const itemsTopbar = [
...

    {
      ...
      onClick: () => goTo('/emergency-contacts'),
    },
    ...
    {
      key: '/emergency-instructions',
      label: 'Emergency Instructions',
      onClick: () => goTo('/emergency-instructions'),
    },

    {
      key: '/police-stations',
      label: 'Police Stations Management',
      onClick: () => goTo('/police-stations'),
    },
  ]
